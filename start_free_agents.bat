@echo off
REM Start Free AI Agents - Quick Setup Script (Windows)
REM This script sets up and tests the free AI agents
...
python -c "from database import supabase; print('✅ Database connected')" 2>nul || echo ⚠️  Database connection issue - check your .env file
echo.
